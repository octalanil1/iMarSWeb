    ...
    $(document).ready(function () 
    {
        $( '#operatorsignupForm' ).on( 'submit', function(e) 
        {
            ...
            $.ajax({
                ...
                cache: false,
                processData: false,
            url: '{{ URL::to('/individualsurveyorsignuppost') }}',
        }).done(function( data ) 
        {  error_remove (); 
			...
			<div class="row">
				<div class="col-md-12">
					<div class="appoint-inner">
                        ...
                        {!! Form::open(array('url' => 'individualsurveyorsignuppost', 'method' => 'post','name'=>'operatorsignupForm','files'=>true,'novalidate' => 'novalidate','id' => 'operatorsignupForm')) !!}
						  <div class="row">
						  <div class="col-md-6">
