    ...
    $(document).ready(function () 
    {
        $( '#operatorsignupForm' ).on( 'submit', function(e) 
        {
            ...
            $.ajax({
                ...
                cache: false,
                processData: false,
            url: '{{ URL::to('/individualoperatorsignuppost') }}',
        }).done(function( data ) 
        {  error_remove (); 
			...
			<div class="row">
				<div class="col-md-12">
					<div class="appoint-inner">
                        ...
                        {!! Form::open(array('url' => 'individualoperatorsignuppost', 'method' => 'post','name'=>'operatorsignupForm','files'=>true,'novalidate' => 'novalidate','id' => 'operatorsignupForm')) !!}
						  <div class="row">
						  <div class="col-md-6">
							  ...
							  <div class="col-md-12">
								...
								<!-- <span>I agree to iMarS's <a href="#" data-toggle="modal" data-target="#exampleModal-5">Terms of Service</a></span> -->
