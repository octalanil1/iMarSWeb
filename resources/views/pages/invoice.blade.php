	...
	<tbody>
		<tr>
			<td style="font-family:'Roboto',Arial,Helvetica; width: 40%; min-width:40%; padding: 5px; border-right:1px solid #e2e2e2;">
				<a href="#"><img src="{{ URL::asset('/public/media') }}/marine.png" alt="Marine"></a>
			</td>
			<td style="text-align: center; width: 30%; padding: 5px; border-right:1px solid #e2e2e2;">
				...
				<p style="margin: 0px; color:red;">Ref. #: {{$data2['content']['survey_number']}}</p>
			</td>
			<td style="text-align: right; width: 30%; padding: 5px;">
				<a href="#"><img src="{{ URL::asset('/public/media') }}/invoice-logo.png" alt="Marine"></a>
			</td>
		</tr>
		<tr>
			<td style="padding: 5px; border-top: 1px solid #e2e2e2; border-right: 1px solid #e2e2e2;">Date: <span>{{$data2['content']['date']}}</span></td>
			<td style="padding: 5px; border-top: 1px solid #e2e2e2; border-right: 1px solid #e2e2e2;text-align:center;">Amount (USD): <span>{{$data2['content']['amount']}}</span></td>
			<td style="padding: 5px; border-top: 1px solid #e2e2e2; text-align: right;">Due Date: <span>{{$data2['content']['due_date']}}</span></td>
		</tr>
		<tr>
			...
			<td colspan="2" style="vertical-align: top; padding: 5px; border-top: 1px solid #e2e2e2;">
				<strong>To:</strong>
				<p style="font-size: 14px; margin-top: 5px;">{{$data2['content']['to']['company']}}
					<span style="display: block; margin-bottom: 3px;word-break: break-all;">Attn: {{$data2['content']['to']['operator_name']}}</span>
					<span style="display: block; margin-bottom: 3px;word-break: break-all;">{{$data2['content']['to']['address1']}}</span>
					<span style="display: block; margin-bottom: 3px;word-break: break-all;">{{$data2['content']['to']['address2']}}</span>
					<span style="display: block; margin-bottom: 3px;word-break: break-all;">{{$data2['content']['to']['email']}}</span>
				</p>
			</td>
		</tr>
		<tr>
						...
						<tr>
							<td>
								<table cellspacing="0" cellpadding="0" width="100%">
									...
									<tbody>
										<tr>
											<td style="text-align: center;padding: 15px 5px; border-top: 1px solid #e2e2e2; border-right: 1px solid #e2e2e2;">{{$data2['content']['survey_number']}}</td>
											<td style="text-align: center;padding: 15px 5px; border-top: 1px solid #e2e2e2; border-right: 1px solid #e2e2e2;">{{$data2['content']['vesselsname']}}</td>
											<td style="text-align: center;padding: 15px 5px; border-top: 1px solid #e2e2e2; border-right: 1px solid #e2e2e2;">{{$data2['content']['imo_number']}}</td>
											<td style="text-align: center;padding: 15px 5px; border-top: 1px solid #e2e2e2;">{{$data2['content']['port_name']}}</td>
										</tr>
									</tbody>
								</table>
							</td>
						...
						<tr>
							<td>
								<table cellspacing="0" cellpadding="0" width="100%">
									...
									<tbody>
										<tr>
											<td style="text-align: left;padding: 5px; border-top: 1px solid #e2e2e2; border-right: 1px solid #e2e2e2;"><?php echo strtoupper($data2['content']['survey_type_name']);?> </td>
											<td style="text-align: center;padding: 5px; border-top: 1px solid #e2e2e2;">USD {{$data2['content']['survey_type_price']}}</td>
										</tr>
										@if($data2['content']['survey_type_id'] !="31")
										<tr>
											<td style="text-align: left;padding: 5px; border-top: 1px solid #e2e2e2; border-right: 1px solid #e2e2e2;">TRANSPORTATION COST </td>
											<td style="text-align: center;padding: 5px; border-top: 1px solid #e2e2e2;">USD {{$data2['content']['port_price']}}</td>
										</tr>
										@endif
										<tr>
											...
											<td style="text-align: center;padding: 5px; border-top: 1px solid #e2e2e2;"><strong style="color: red;">USD {{$data2['content']['amount']}}</strong></td>
										</tr>
										<tr>
											...
											<td style="text-align: center;padding: 5px; border-top: 1px solid #e2e2e2;">
												<strong style="color: red;">{{$data2['content']['due_date']}}</strong>
											</td>
										</tr>
									</tbody>
								</table>
