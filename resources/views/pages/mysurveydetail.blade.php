        ...
        {!! Form::close() !!} -->
                    ...
                    <div class="row">
                        ...
                        { ?>
                            ...
                            <input type="hidden" name="cat_price" id="cat_price" value="{{$total_price}}">
        ...
        <?php }?>
				...
				<div class="col-md-12">
					<div class="box-outer">
                        ...
                        @if($user->type=='0' && $surveyor_data->status=='1')
                    ...
                    @foreach($csurvey_users as $cusers)
                        <li> 
                            ...
                            <span>
                                ...
                                { 
                                    if($cusers->rating < $i ) {
                                        if(is_float((float)$cusers->rating ) && (round((float)$cusers->rating ) == $i)){
