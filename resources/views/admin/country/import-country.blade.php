<script type="text/javascript">
        ...
        $( '#addProductInventory' ).on( 'submit', function(e) 
        {
            ...
            $.ajax({
               ...
               type: "POST",
                ...
                cache: false,
                 processData:false,
                  url: '{{ URL::to('/admin/import-country-post') }}',
    ...
    {!! Form::open(array('url' => '/admin/import-country-post', 'method' => 'post','name'=>'addProductInventory','files'=>true,'novalidate' => 'novalidate','id' => 'addProductInventory')) !!}

    <a href="{{asset('/media/sample_country_import.xlsx')}}">Download Sample File</a>
