<script type="text/javascript">
    ...
    { $.LoadingOverlay("hide");
        $( '#addContentForm' ).on( 'submit', function(e) 
        {
            ...
            $.ajax({
                dataType: 'json',
            data: {title:title,description:description,user_type:user_type}, 
            type: "POST",
            ...
            <div class="panel-body">
                ...
                <div class="col-12 col-sm-12 col-md-12">
                            <div class="row form-group">
                                ...
                                {!! Form::select('user_type',["all"=>'All','operator'=>'Operator','surveyor'=>'Surveyor'],null, ['class' => 'form-control','required'=>'required','id'=>'user_type','onkeypress' => 'error_remove()' ]) !!}
                                </div>
                            </div>
                        </div>
                <div class="col-12 col-sm-12 col-md-12">
