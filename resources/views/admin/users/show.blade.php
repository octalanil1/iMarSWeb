...
<script type="text/javascript">
	...
	function reset_password(edit_id) {

        $.LoadingOverlay("show");
        $('#UserModal').html(''); $(".form-title").text('Reset Password');
        $('#UserModal').load('{{ URL::to('/admin/reset-password') }}'+'/'+edit_id);
        $("#myModal").modal();
    }
        ...
        <div class="col-xs-12 page-user">
          <div class="box">
           ...
           <div class="col-xs-12 col-sm-6 col-md-2">
            <label></label>
            <?php $helper=new App\Helpers;?>
            {!! Form::select('status',[''=>'Select Status','1'=>'Active','2'=>'Pending','0'=>'Deactivated',],['1'], ['class' => 'form-control','required'=>'required','onkeypress' => 'error_remove()']) !!}
           </div>
