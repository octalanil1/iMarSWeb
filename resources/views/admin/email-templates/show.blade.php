...
<script type="text/javascript">
    ...
    function add_record() {
        ...
        $.LoadingOverlay("show");
        $('#UserModal').html(''); $(".form-title").text('Add Email Templates');
        $('#UserModal').load('{{ URL::to('/admin/add-email-templates') }}');
        $("#myModal").modal();
    }
...
<section class="content-header"><h1>Email Templates<small>List</small></h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12 page-user">
          <div class="box">
            ...
            <div class="col-xs-12 col-sm-6 col-md-8">
                ...
                <a href="javascript:" style="margin-top: 20px;" class="custom-btn pull-right btn btn-outline-primary btn-labeled" onclick="add_record();" title="Add Template"><span class="btn-label icon fa fa-plus"></span>Add </a>
