<script type="text/javascript">
    ...
    { $.LoadingOverlay("hide");
        $( '#editCatgeoryForm' ).on( 'submit', function(e) 
        {
            ...
            $.ajax({
                ...
                cache: false,
                processData: false,
            url: '{{ URL::to('/admin/edit-survey-category-post') }}',
        }).done(function( data ) 
    ...
    {!! Form::open(array('url' => '/admin/edit-survey-category-post', 'method' => 'post','name'=>'editCatgeoryForm','files'=>true,'novalidate' => 'novalidate','id' => 'editCatgeoryForm')) !!}
                    ...
                    <div class="col-12 col-sm-12 col-md-6">
					 ...
					 <div class="col-12 col-sm-12 col-md-6">
                        <div class="row form-group">
                            ...
                            {!! Form::text('code',$catdata->code, ['class' => 'form-control','placeholder' => 'Name','required'=>'required','id'=>'code','onkeypress' => 'error_remove()' ]) !!}
                            </div>
