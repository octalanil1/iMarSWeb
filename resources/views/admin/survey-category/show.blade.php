...
<script type="text/javascript">
    ...
    function search() {
        ...
        $.ajax({
            type: 'POST',
            url: '{{ URL::to('/admin/survey-category') }}',
    ...
    function add_record() {
        ...
        $('#UserModal').load('{{ URL::to('/admin/add-survey-category') }}');
        $("#myModal").modal();
    }
    ...
    function edit_record(edit_id) {
        ...
        $('#UserModal').load('{{ URL::to('/admin/edit-survey-category') }}'+'/'+edit_id);
        $("#myModal").modal();
    }
 ...
 function statusChange(id) 
    {
      ...
      $.ajax({
            ...
            data: { id:id}, 
            type: "POST",
            url: '{{ URL::to('/admin/survey-category-status') }}',
        }).done(function( data ) 
        {   
          search();
    ...
    $(document).ready(function() {
        ...
        loadPiece( '{{ URL::to('/admin/survey-category') }}');
    })

</script>
<section class="content-header"><h1>Survey Category</h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Survey Category Table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body" id="replace-div">
                 @include('admin.survey-category.search')
           </div>
            <!-- /.box-body -->
          </div>
