<script type="text/javascript">
    ...
    { $.LoadingOverlay("hide");
        $( '#addUserForm' ).on( 'submit', function(e) 
        {
            ...
            $.ajax({
                ...
                cache: false,
                processData: false,
            url: '{{ URL::to('/admin/add-survey-category-post') }}',
        }).done(function( data ) 
    ...
    {!! Form::open(array('url' => '/admin/add-survey-category-post', 'method' => 'post','name'=>'addUserForm','files'=>true,'novalidate' => 'novalidate','id' => 'addUserForm')) !!}
                ...
                <div class="alert alert-danger" style="display:none"></div>
					...
					<div class="col-12 col-sm-12 col-md-6">
                            <div class="row form-group">
                                ...
                                {!! Form::select('status',[''=>'Select Status','0'=>'Deactive','1'=>'Active'],[''], ['class' => 'form-control','required'=>'required','id'=>'status','onkeypress' => 'error_remove()']) !!}
                                </div>
