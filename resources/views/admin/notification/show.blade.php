...
<script type="text/javascript">
    ...
    function add_record() {
        ...
        $.LoadingOverlay("show");
        $('#UserModal').html(''); $(".form-title").text('Add Notification');
        ...
        <div class="col-xs-12 page-user">
          <div class="box">
           ...
           <div class="col-xs-12 col-sm-6 col-md-2">
            ...
            {!! Form::select('user_type', $helper->UserTypeList(),null, ['class' => 'form-control','onkeypress' => 'error_remove()']) !!}
           </div>
           ...
           <div class="col-xs-12 col-sm-6 col-md-2">
            ...
            <div class="col-xs-12 col-sm-6 col-md-8">
                ...
                <!-- <button style="margin-top: 20px;margin-left: 10px;" onclick="exportData();" class="btn btn-outline-danger pull-left" type="submit">Export</button>-->
                 <a href="javascript:" style="margin-top: 20px;" class="custom-btn pull-right btn btn-outline-primary btn-labeled" onclick="add_record();" title="Add Notification"><span class="btn-label icon fa fa-plus"></span>Add Notification</a> 
          </div>
            {!! Form::close() !!}
